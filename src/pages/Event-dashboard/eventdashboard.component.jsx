            ...
            <div key = {event.id}>
              ...
              <EventTile eventTitle={event.eventtitle} artitstName={event.artist} eventDate={event.date}
               eventTime={event.time} artistImageURL = {event.artistImageURL}/>
                 ...
                 <Profile profile = {event.profile} url = {event.youtubeurl} price = {event.price} orderId = {event.orderId} eventtitle = {event.eventtitle} eventId = {event.id} buttonLabel = 'View Details'> </Profile>

  ...
  <div className = 'inspiration' id='inspiration'>
    ...
    <div className='row'>
      <div className='col-12 col-sm-12 col-md-12 col-xl-12'>
        ...
        <h2 className='inspiration-text'>Our beloved Guruji <strong>Pandit Ulhas Rajhans</strong> inspired us to create a platform to help musicians during the tough time faced by
